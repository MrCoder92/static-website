...
Change the Amazon provided URL to your custom URL
Head to Amazon Route 53, click on hosted zone
click into the domain name to and add additional record to connect the bucket to Route 53
Select the simple routing policy, for the value the endpoint should be alias to S3 website endpoint, select the region the website is hosted 
and finally select the S3 endpoint which is already provided 
